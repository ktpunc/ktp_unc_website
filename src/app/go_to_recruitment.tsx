  ...
  return (
    <section className="bg-blue-pale py-20 border-y border-blue-mid">
      ...
      >
        ...
        <h2 className="text-3xl md:text-4xl font-black text-navy mb-3">Applications Open Soon</h2>
        <div className="section-divider-center" />
        <p className="text-slate-500 text-lg leading-relaxed mb-8 max-w-xl mx-auto">
          Recruitment will return in Fall 2026. Open to all UNC undergraduates with a passion for technology, curiosity, and a 2.5+ GPA.
        </p>
